...
class EncoderModel(tf.keras.Model):
    ...
    def __init__(self, out_channels: int):
        ...
        self.nn_conv_1 = Conv2D(64, (5, 5), strides=2, padding='same', name='nn_conv_1',
        ...
        self.nn_conv_2 = Conv2D(64, (3, 3), strides=2, padding='same', name='nn_conv_2',
                                kernel_regularizer=L2(l2_factor))
        ...
        self.nn_conv_3 = Conv2D(out_channels, (3, 3), strides=2, padding='same', name='nn_conv_3',
                                kernel_regularizer=L2(l2_factor))
        self.act_3 = Activation('sigmoid', name='act_3')
...
class DecoderModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # first convolution layer with batch normalization and max pooling
        self.nn_conv_1 = Conv2DTranspose(32, (5, 5), strides=2, padding='same', name='nn_conv_1',
                                         kernel_regularizer=L2(l2_factor))
        self.act_1 = Activation('relu', name='act_1')
        self.dropout_1 = Dropout(rate=dropout_rate, name='dropout_1')
        ...
        # second convolution layer with batch normalization and max pooling
        self.nn_conv_2 = Conv2DTranspose(32, (3, 3), strides=2, padding='same', name='nn_conv_2',
                                         kernel_regularizer=L2(l2_factor))
        self.act_2 = Activation('relu', name='act_2')
        self.dropout_2 = Dropout(rate=dropout_rate, name='dropout_2')
        ...
        # third convolution layer with batch normalization and max pooling
        self.nn_conv_3 = Conv2DTranspose(16, (3, 3), strides=2, padding='same', name='nn_conv_3',
                                         kernel_regularizer=L2(l2_factor))
        ...
        self.nn_conv_out = Conv2D(1, (1, 1), strides=1, padding='same', name='nn_conv_4',
                                  kernel_regularizer=L2(l2_factor))
        self.act_out = Activation('sigmoid', name='act_3')
...
class AutoEncClassifModel(tf.keras.Model):
    ...
    def __init__(self, encoder: EncoderModel, num_classes: int = 7):
        super(AutoEncClassifModel, self).__init__()
        ...
        self.dense_1 = Dense(units=64, activation='relu', name='dense_1')
        self.dense_2 = Dense(units=64, activation='relu', name='dense_2')
        self.dense_3 = Dense(units=64, activation='relu', name='dense_3')

        self.dense_out = Dense(units=num_classes, activation='softmax', name='dense_out')
...
class AutoEncEatModel(tf.keras.Model):
    ...
    def __init__(self, out_channels=32):
        ...
        self.nn_encoder = EncoderModel(out_channels=out_channels)
