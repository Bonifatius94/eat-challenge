...
from model.custom_layers import NoisyDense, NoisyConv2D


class NoisyEatModel(tf.keras.Model):

    def __init__(self, num_classes: int):
        super(NoisyEatModel, self).__init__()
        ...
        self.nn_conv_3 = NoisyConv2D(32, (3, 3), strides=1, padding='SAME', name='nn_conv_3')
        ...
        self.nn_conv_5 = NoisyConv2D(32, (3, 3), strides=1, padding='SAME', name='nn_conv_5',
                                kernel_regularizer=L2(l2_factor))
